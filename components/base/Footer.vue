<template>
  <footer class="w-full mx-auto bg-[#004a7f]">
    <div class="w-full border-y border-[#DDDDDD]">
      <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        <div
          ...
          <div class="sm:hidden xl:block mb-6 sm:mb-0 p-4">
            ...
            <div class="mt-4 text-md text-white">
              ...
              i suoi prodotti di software gestionali per il mercato
              svizzera. La suite si compone di 5 moduli (ordini, contabilità, salari, start-up, supporto)
            </div>
          </div>
        </div>
        <div
          ...
          <ul class="space-y-4">
            ...
            <NavLink name="Salari" url="/salari" />
            <NavLink name="Startup" url="/startup" />
        ...
        <div
          ...
          <img :src="require('~/assets/img/peoples.png')" class="w-[240px] abs" alt="dp Logo" />
    ...
    <div class="bg-[#00B2FF] flex flex-row px-8 py-8 sm:py-4 text-left text-sm text-white hover:text-gray-900 items-center">
      <img data-aos-once="true" :src="require('~/assets/img/logodp.png')" class="mt-4 mb-4 w-[200px]" alt="" />
      <span class="font-bold ml-8 text-1xl">
        +41 81 839 00 00
      </span>
      <a href="mailto:support@dpstudio.ch"
            class="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white-600 ml-8" style="color: white !important;">support@dpstudio.ch</a>
    </div>
  </footer>
</template>
<script>
